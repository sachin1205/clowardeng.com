...
<?php endif; ?>
	...
	<?php elseif( get_row_layout() == 'project_module' ): ?>
		
	<?php if( have_rows('pm_item') ): 
	$i = 1;
	while ( have_rows('pm_item') ) : the_row(); ?>

		<!-- project module start -->
		<div class="project-module
		<?php 
		if($i %2 == 0):
			echo 'project-module-right';
		endif;
		?>
		" id="<?php echo 'pm_item'.$i;?>">
			<div class="clearfix">

				<?php if(get_sub_field('pm_image')) : ?>
				<figure class="pm-fig os-animation obj-animation-duration" data-os-animation="
				<?php 
				if($i %2 == 0):
					echo 'fadeInRight';
				else:
				...
				?>" data-os-animation-delay="0.3s">
					...
					<?php $pm_image = get_sub_field('pm_image'); ?>
					<img src="<?php echo $pm_image['url']; ?>" alt="<?php echo $pm_image['alt']; ?>" title="<?php echo $pm_image['alt']; ?>">

				</figure>
				<?php endif; ?>


				<div class="pm-content os-animation obj-animation-duration" data-os-animation="
				<?php 
				if($i %2 == 0):
					echo 'fadeInLeft';
				else:
				...
				?>" data-os-animation-delay="0.3s">
					...
					<h2 class="pmc-heading"><?php the_sub_field('pm_heading');?></h2>
					<?php endif;?>

					<?php if(get_sub_field('pm_text')):?>
					<div class="pmc-text"><?php the_sub_field('pm_text');?></div>
					<?php endif;?>


					<div class="pmc-icons">

						<?php if( have_rows('pm_social_icons') ):
						while ( have_rows('pm_social_icons') ) : the_row(); ?>
						
						<?php if(get_sub_field('pm_social_link')):?>
						<a href="<?php the_sub_field('pm_social_link');?>">

							<?php $pm_social_image = get_sub_field('pm_social_image'); ?>
							<img src="<?php echo $pm_social_image['url']; ?>" alt="<?php echo $pm_social_image['alt']; ?>" title="<?php echo $pm_social_image['alt']; ?>">
